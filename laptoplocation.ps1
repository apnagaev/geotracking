...
$inginction = ''
if ($userstatus -eq 'logged on') {$inginction = '&inginction=true'}
if ($userstatus -eq 'locked') {$inginction = '&inginction=false'}
